...
# from app.models.found_wallet import create_found_wallet
...
# @routes_bp.route("/wallet", methods=['GET', 'POST'])
# @login_required
# def wallet():
...
# @routes_bp.route("/referrals", methods=['GET', 'POST'])
# @login_required
# def referrals():
#     if request.method == 'GET':
...
# @routes_bp.route("/add_found_wallet", methods=["POST"])
# @login_required
# def add_found_wallets():
#     # Crear un registro de found wallet
#     user_id = current_user.id
#     amount = request.form.get("amount")
#     symbol = "USDT" # request.form.get("symbol")
...
#     result = wallet.add_found_wallet(amount, symbol, ref)
...
# @routes_bp.route("/get_found_wallets", methods=["GET"])
# @login_required
